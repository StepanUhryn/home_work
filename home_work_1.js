...
let myVar = 'hhhhhhhhhhhhhh jjjjjjjjjjjjjj';
...
let myHobbyArray = ['Fishing', 'Auto', 'Mushroom', 'IPshing'];
let myObject = { 
    Name : 'Viktor',
    last_Name : 'Ivanov',
    date_of_birth : '30.02.1988',
    age: 32,
